angular.module('checkin').controller('EquipeMain', function($scope, $http, $window) {
    ...
    function pesquisar(dtInicial, dtFinal) {                                  
        ...
        $http.get(external).then(function (response) {                        
            ...
            ///HorasEquipe/Index#!/horas-equipe/relatorio
            $window.location.href = '/HorasEquipe/Index#!/';  
            $window.location.href = '/HorasEquipe/Index#!/horas-equipe/relatorio';  
        }, function (response) {
