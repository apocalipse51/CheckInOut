      ...
      container.innerHTML = `
        <div class="tool clearfix">
          ...
          <div class="btn-container">
            ...
            <button type="button" class="btn btn-warning" onclick="EditarUsuario('${user.usr_Id}', '${user.usr_Login}', '${user.usr_Nome}', '${user.usr_Email}', '${(user.usr_Tel === "")? "Não informado" : user.usr_Tel }', '${user.fnc_Nome}', '${user.estr_Nome}', '${user.estr_apr}', '${user.estr_apr}', '${user.usr_imagePerfil}');">Editar</button>
          </div>
        </div>
